...
교육 흐름은 **0장 환경 준비 → 1~3장 물리·관절·카메라 → 4장 텔레옵 → 5장 시연 취득 → 6장 변환·학습·추론**입니다.
5장에서 저장한 시연을 선택하고 6장에서 LeRobot 데이터셋으로 변환·검사합니다.
변환·학습은 로컬만으로 진행할 수 있습니다. 필요한 학생은 검사 완료 후 별도 스크립트로 Hugging Face에 선택 업로드할 수 있습니다.

[6장](../isaacsim_basic/06_lekiwi_dataset/README.md#3-변환-스크립트-수정하고-실행하기)에서
