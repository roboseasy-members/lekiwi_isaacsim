...
기록 패널의 실제 화면 5장은 도면 TF를 적용한 실행에서 다시 촬영했습니다. 30초 제한을 설정하고 3.30초·99프레임에서 수동 종료한 예입니다.
...
이 터미널 이미지는 앞서 검증한 **2개 에피소드·19프레임**의 별도 변환 예시입니다. 위에서 새로 촬영한 99프레임 기록의 변환 결과는 아닙니다.
